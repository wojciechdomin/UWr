...
let to_ast prog =
let rec to_ast prog stack  = 
match prog,stack with
| [], [e] -> e
| (PushInt i) :: prog', _ -> to_ast prog' ((Ast.Int i) :: stack)
| (Binop Add) :: prog', a :: b :: stack' -> to_ast prog' ((Binop(Add,b,a)) :: stack')
| (Binop Sub) :: prog', a :: b :: stack' -> to_ast prog' ((Binop(Sub,b,a)) :: stack')
| (Binop Mult) :: prog', a :: b :: stack' -> to_ast prog' ((Binop(Mult,b,a)) :: stack')
| (Binop Div) :: prog', a :: b :: stack' -> to_ast prog' ((Binop(Div,b,a)) :: stack')
| _ -> failwith "wielbłąd!"
in to_ast prog []
;;
